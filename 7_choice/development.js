...
<div class="card">
  ...
  <div class="card-body">
    ...
    <a href="#" class="btn btn-primary" data-btn="price" data-id="${box.id}" style="font-size: 50px; background-color: #b91784; border: 1px solid #2c3f50">ВЫБРАТЬ</a>
  </div>
</div>
</div>
`
...
document.addEventListener('click', (event) => {
  ...
  if (btnType === 'price') {
    windowMessage.setContent(
      `<p style="font-size: 40px">Снять видео, где ты чистишь банан без помощи рук.</p>`
    )
    windowMessage.open()
  }
})
