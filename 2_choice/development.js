...
<div class="card">
  ...
  <div class="card-body">
    ...
    <a href="#" class="btn btn-primary" data-btn="price" data-id="${box.id}" style="font-size: 50px; background-color: #27a63b; border: 1px solid #2c3f50">ВЫБРАТЬ</a>
  </div>
</div>
</div>
`
...
document.addEventListener('click', (event) => {
  ...
  if (btnType === 'price') {
    windowMessage.setContent(
      `<p style="font-size: 40px">Руслан должен съесть лимон на видео 🍋</p>`
    )
    windowMessage.open()
  }
})
